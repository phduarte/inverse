...
public class TableTests
{
    ...
    public void ShouldCalculateWidth()
    {
        ...
        _table.AddColumn(new Column { Name = "NOME_DA_COLUNA" });
    ...
    public void ShouldCalculateForeignKeysCount()
    {
        ...
        _table.AddColumn(new ForeignKey { Name = "FK_NAME" });
    ...
    public void ShouldCalculatePrimaryKeysCount()
    {
        ...
        _table.AddColumn(new PrimaryKey { Name = "FK_NAME" });
    ...
    public void ShouldNotAllowColumnsWithoutName()
    {
        ...
        {
            _table.AddColumn(new Column { Id = "1" });
        });
    }
    ...
    {
        _table.AddColumn(new Column { Id = "1", Name = "ID" });
        _table.AddColumn(new Column { Id = "2", Name = "NAME" });
    ...
    {
        _table.AddColumns((System.Collections.Generic.IEnumerable<Column>)(new[]
        {
    ...
    {
        _table.AddColumn(new ForeignKey { Id = "1", Name = "ID" });
        _table.AddColumn(new ForeignKey { Id = "1", Name = "ID" });
    ...
    {
        _table.AddColumn(new ForeignKey { Id = "1", Name = "ID" });
        _table.AddColumn(new ForeignKey { Id = "1", Name = "NAME" });
