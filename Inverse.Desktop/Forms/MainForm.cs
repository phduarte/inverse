...
public partial class MainForm : Form
{
    ...
    private void bringToFrontToolStripMenuItem_Click(object sender, EventArgs e)
    {
        ...
        {
            _database.BringTableToFront(_activeTable);
        }
    }
    ...
    private void sendToBackToolStripMenuItem_Click(object sender, EventArgs e)
    {
        if (_activeTable is not null)
        {
            _database.SendTableToBack(_activeTable);
        }
    }
    ...
    private void setAsPrimaryKeyToolStripMenuItem_Click(object sender, EventArgs e)
    {
    ...
    private void setAsForeignKeyToolStripMenuItem_Click(object sender, EventArgs e)
    {
        if (_activeColumn is not null)
        {
    ...
    private void removeForeignKeyToolStripMenuItem_Click(object sender, EventArgs e)
    {
        if (_activeColumn is not null)
        {
